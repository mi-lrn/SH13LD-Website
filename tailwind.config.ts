		...
		extend: {
			colors: {
				...
				cyber: {
					...
					'secondary-glow': 'hsl(var(--cyber-secondary-glow))',
			...
			keyframes: {
				...
				'cyber-pulse': {
					'0%, 100%': {
						opacity: '1',
						boxShadow: '0 0 20px hsl(var(--cyber-glow))'
					},
					'50%': {
						opacity: '0.8',
						boxShadow: '0 0 40px hsl(var(--cyber-glow)), 0 0 60px hsl(var(--cyber-glow))'
					}
				},
				'float': {
					'0%, 100%': {
			...
			animation: {
				...
				'travel-horizontal': 'travel-horizontal 8s linear infinite',
				'travel-vertical': 'travel-vertical 10s linear infinite',
